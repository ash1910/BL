...
<div class="element">
	...
	@csrf
			...
			<tr>
				...
				<td class="no-border-rb" colspan="3">
					...
					<table style="width: 300px; margin: 0;">
						...
						<textarea id="for_delivery_apply_to" name="for_delivery_apply_to" style="width:98%; height: 100%;"></textarea>
					</td>
						</tr>
            ...
            <tr>
			<td class="no-border-lb" rowspan="3" style="width: 180px;">
			<textarea class="ck-editor__editable_inline" id="editor1" type="text" name="marks_container_seal_no" style="width:96%; height: 99%;"></textarea>
			</td>
			<td class="no-border-tb" rowspan="3" style="width: 100px;">
			<textarea id="number_of_packages" type="text" name="number_of_packages" style="width:95%; height: 99%"></textarea>
			</td>
			<td class="no-border-bottom" rowspan="3">
			<textarea class="ck-editor__editable_inline" id="editor" type="text" name="description_of_packages_and_goods"></textarea>
			</td>
			<td class="no-border-bottom" style="width:100px;">
			<textarea id="gross_weight" type="text" name="gross_weight" style="width:95%; height: 99%;"></textarea>
			</td>
			<td class="no-border-rbl" rowspan="2" style="width:100px;">
