...
.table-container {
	...
	@method('PUT')
            <table>
			<tr>
				<td class="no-border-left" colspan="2" style="height: 100px;" width="100px">SHIPPER<br>
