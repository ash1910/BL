...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2024 at 01:05 PM
...
CREATE TABLE `bls` (
  ...
  `for_delivery_apply_to` text NOT NULL,
  `ocean_vessel` text NOT NULL,
  `voyage_no` text NOT NULL,
  `port_of_discharge` text NOT NULL,
  `place_of_delivery` text NOT NULL,
  `final_destination` text NOT NULL,
  `freight_payable_at` text NOT NULL,
  `number_of_original_bl` text NOT NULL,
  `marks_container_seal_no` text NOT NULL,
  `number_of_packages` text NOT NULL,
  `description_of_packages_and_goods` text NOT NULL,
  `gross_weight` text NOT NULL,
  `measurement` text NOT NULL,
  `shipped_on_board_the_vessel` text NOT NULL,
  `on_board_date` date NOT NULL,
  `freight_and_charges` text NOT NULL,
...
('9vVaaDAvpnx66MnJJkPbyjEE1Vr4WXXSqwHt9anI', 19, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '', 1724842159);
...
(1, 'TEST', 'TEST@TEST.COM', NULL, '$2y$12$LAM8NTxZSZdhrBq5ceXkf.n8H179wBmFRxT8eIz2zfD0zlnoCGFJO', 0, NULL, '2024-08-08 02:26:35', '2024-08-22 04:45:07'),
