    ...
    if (!editor1) {
        ClassicEditor
            .create(document.querySelector('#editor1'), {
                initialData: '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**** SEA/AIR SHIPMENT ****</p>' // This is the initial data to be displayed
            })
            .then(ckeditor => {
                editor1 = ckeditor;

                // Optionally, you can update the editor's data after initialization
                // If you want to load data from the textarea, ensure it has the correct value
